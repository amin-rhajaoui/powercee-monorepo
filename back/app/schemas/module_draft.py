...
class ModuleDraftBase(BaseModel):
    ...
    module_code: str = Field(..., min_length=1, max_length=50, description="Code du module (ex: BAR-TH-171, BAR-TH-175)")
    ...
    project_id: UUID | None = Field(None, description="ID du projet parent pour BAR-TH-175 (peut être null)")
