/**
 * BAR-TH-175 Step 1: Household (Client Selection)
 * Adapted from BAR-TH-171 Step1Household
 */
...
export function Step1Household({ draftId, initialDraft }: Step1HouseholdProps) {
    ...
    const handleNext = () => {
        ...
        navigate(
            ...
            (id) => `/(app)/bar-th-175/step2?draftId=${id}`
        );
    };
            ...
            <ScrollView className="flex-1 px-4 py-6">
                <View className="mb-6">
                    ...
                    <Text className="text-gray-600">
                        Choisissez le client pour ce dossier de rénovation d'ampleur
                    </Text>
                </View>
                    ...
                    <View className="flex-row items-start gap-3">
                        ...
                        <View className="flex-1">
                            ...
                            <Text className="text-sm text-blue-700">
                                Rénovation d'ampleur d'un appartement - Particuliers et professionnels
                            </Text>
                        </View>
                    </View>
                </View>
