/**
 * BAR-TH-175 Module - Index (Overview + Step1)
...
import { Step1Household } from '@/components/modules/bar-th-175/Step1Household';

const MODULE_ID = 'bar-th-175';
const MODULE_CODE = 'BAR-TH-175';

export default function BarTh175Index() {
    ...
    useEffect(() => {
        if (
            ...
            const stepRoutes: Record<number, string> = {
                2: `/(app)/bar-th-175/step2?draftId=${draftId}`,
                3: `/(app)/bar-th-175/step3?draftId=${draftId}`,
                4: `/(app)/bar-th-175/step4?draftId=${draftId}`,
            };
    ...
    const handleNewDraft = () => {
        router.push('/(app)/bar-th-175?draftId=new');
    };
