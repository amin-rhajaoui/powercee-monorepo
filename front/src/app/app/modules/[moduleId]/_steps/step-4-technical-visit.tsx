  ...
  const handleValidateFolder = async (e?: React.MouseEvent) => {
    ...
    try {
      ...
      await saveDraft(
        {
          step4: {
            nb_levels: values.nb_levels ?? undefined,
            avg_ceiling_height: values.avg_ceiling_height ?? undefined,
            target_temperature: values.target_temperature ?? undefined,
            attic_type: values.attic_type ?? undefined,
            is_attic_isolated: values.is_attic_isolated ?? undefined,
            attic_isolation_year: values.attic_isolation_year ?? undefined,
            floor_type: values.floor_type ?? undefined,
            is_floor_isolated: values.is_floor_isolated ?? undefined,
            floor_isolation_year: values.floor_isolation_year ?? undefined,
            wall_isolation_type: values.wall_isolation_type ?? undefined,
            wall_isolation_year_interior: values.wall_isolation_year_interior ?? undefined,
            wall_isolation_year_exterior: wallYearExterior ?? undefined,
            joinery_type: values.joinery_type ?? undefined,
            emitters_configuration: values.emitters_configuration ?? undefined,
          },
        },
        4,
        undefined
