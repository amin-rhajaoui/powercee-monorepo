...
import { Zap, Thermometer, Droplets, Plug, Volume2 } from "lucide-react";
...
export function HeatPumpCard({ pac }: HeatPumpCardProps) {
  return (
    <Card className="hover:shadow-md transition-shadow">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="text-lg font-semibold">{pac.price_ht.toLocaleString("fr-FR")} €</span>
        </div>
